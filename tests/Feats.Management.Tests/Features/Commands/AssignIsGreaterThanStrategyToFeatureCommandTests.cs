...
{
    public class AssignIsGreaterThanStrategyToFeatureCommandTests : TestBase
    {
        [Test]
    ...
    public static class AssignIsGreaterThanStrategyToFeatureCommandTestsExtensions 
    {
        public static AssignIsGreaterThanStrategyToFeatureCommand GivenValidCommand(this AssignIsGreaterThanStrategyToFeatureCommandTests tests)
        {
        ...
        public static Action WhenValidating(this AssignIsGreaterThanStrategyToFeatureCommand command)
        {
        ...
        public static void ThenWeGetAFeaturePublishedEvent(this Func<StrategyAssignedEvent> featFunc, AssignIsGreaterThanStrategyToFeatureCommand command, ISystemClock clock)
        {
            var feat = featFunc();
            ...
            feat.StrategyName.Should().Be(StrategyNames.IsGreaterThan);
