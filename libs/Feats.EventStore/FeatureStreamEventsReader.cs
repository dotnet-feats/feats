...
{
    internal sealed class FeatureStreamEventsReader : IReadStreamedEvents<FeatureStream>
    {
        ...
        private IEvent? FromResolvedEvent(ResolvedEvent @event)
        {
            ...
            switch(@event.Event.EventType)
            {
                ...
                case EventTypes.FeatureUpdated:
                    return JsonSerializer.Deserialize<FeatureUpdatedEvent>(json);
